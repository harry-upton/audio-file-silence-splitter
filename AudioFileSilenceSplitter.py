...
parser.add_argument("format", type=str, help="The format of the input audio file, eg. 'wav' or 'mp3'. mp3 requires ffmpeg.")
...
minSilenceLength = args.min_silence_length
padding = args.padding
br = args.bitrate

def split(name, inputFormat, outputFormat, threshold, minSilenceLength, padding, br):
...
if __name__ == "__main__":
    split(name, inputFormat, outputFormat, threshold, minSilenceLength, padding, br)
